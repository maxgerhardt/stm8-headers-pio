...
/*----------------------------------------------------------
    SELECT BOARD
----------------------------------------------------------*/
//STM8S_DISCOVERY is already defined in the board definition for the stm8sdisco board
//let the platformio.ini inject the build flags dynamically for the pin mapping if needed.
